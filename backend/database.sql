...
VALUES
  ('Mochila tradicional', 'Iguaran Epieyu', 120000.00, 'Mochilas', NULL),
  ('Pulsera tejida', 'Pushaina Uriana', 35000.00, 'Accesorios', NULL),
  ('Chinchorro wayuu', 'Jusayu Ipuana', 280000.00, 'Hogar', NULL),
